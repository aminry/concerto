...
## Corpus Check
- 16526 files · ~11,920,840 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 60389 nodes · 84250 edges · 9222 communities (6306 shown, 2916 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 572 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `544db5f0`
...
- `loadLayoutState()` --references--> `Tauri 2 Shell + React SPA`  [INFERRED]
  apps/desktop/src/state/useUiStore.ts → design/15_Desktop_Client.md
...
- 1-file cycle: `spikes/tonic-iroh/src/bin/bench.rs -> spikes/tonic-iroh/src/bin/bench.rs`
...
- **Agent host detachment + hot/cold resume across Core restart** — design_00_architecture_overview_concerto_agent_host, design_01_core_daemon_runtime_host_adoption, design_04_agent_supervisor_host_cold_resume [EXTRACTED 0.90]
- **Coordinated PR-set merge across workarea/VCS/scheduler** — design_03_workspace_session_manager_pr_set, design_13_vcs_provider_integration_pr_set_merge, design_05_scheduler_wait_for_checks [EXTRACTED 1.00]
- **Remote Transport Stack (Iroh + Tonic + Relay)** — design_concerto_techstack_evaluation_iroh, design_concerto_techstack_evaluation_tonic_grpc, design_concerto_prd_minimal_relay, spikes_tonic_iroh_findings_hand_rolled_adapter [INFERRED 0.85]
...
## Communities (9222 total, 2916 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (79): errorMessage(), aggregateBand(), checkBand, CheckConclusion, CheckRun, ChecksCheckRunFrame, ChecksDeploymentFrame, ChecksFrame (+71 more)

### Community 1 - "Community 1"
Cohesion: 0.12
Nodes (25): Debug, Default, JoinHandle, Option, Path, PathBuf, PermissionMode, Receiver (+17 more)

### Community 2 - "Community 2"
Cohesion: 0.13
Nodes (17): BoxEventStream, AgentSupervisorHandle, Arc, AtomicU64, Drop, HashMap, Mutex, Sender (+9 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (42): Arc, CancellationToken, Channel, Connection, EchoReply, EchoRequest, Endpoint, EndpointAddr (+34 more)
...
Cohesion: 0.13
Nodes (38): AppHandle, Box, CoreClient, CoreClientError, HashMap, JoinHandle, M, Mutex (+30 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (24): CoreSecretSlot, Into, Option, Result, SecretValue, Self, String, VcsSecretSlot (+16 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (60): addRepository(), AddRepositoryInput, CloneStrategy, estimateRepoSize(), listRepositories(), ListRepositoriesResponse, listTree(), ListTreeResponse (+52 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (49): CancellationToken, Endpoint, EndpointId, Option, RecvStream, RelayUrl, Result, Self (+41 more)

### Community 9 - "Community 9"
Cohesion: 0.14
Nodes (26): Drop, HandshakeState, IdentityError, Instant, NoiseSession, Option, R, Result (+18 more)

### Community 10 - "Community 10"
Cohesion: 0.12
Nodes (30): AllowRoot, Error, Option, P, Path, PathBuf, Persistence, Repository (+22 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (54): AgentSupervisorHandle, Arc, CheckRun, CreatePrRequest, IssueDetail, Option, ProtoPullRequest, Request (+46 more)
...
Cohesion: 0.11
Nodes (43): Arc, CheckRunSnapshot, CheckRunsSource, HashMap, MergeMethod, MergeProgress, MergeReport, Mutex (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.12
Nodes (30): AgentEvent, Arc, BTreeMap, CheckRunsSource, HashMap, Instant, Mutex, Notify (+22 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (48): completePairingFromPayload(), CompletePairingResult, CoreTransportKind, decodePairingPayload(), encodePairingPayload(), getActiveCore(), listPairedCores(), PairedCore (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.12
Nodes (24): Error, Into, Option, Result, Self, Send, String, Sync (+16 more)

### Community 17 - "Community 17"
Cohesion: 0.15
Nodes (25): ActorViewEntry, Arc, C, CancellationToken, HashMap, Instant, JoinHandle, Persistence (+17 more)

### Community 18 - "Community 18"
Cohesion: 0.19
Nodes (27): Channel, Option, PathBuf, Result, Status, String, TempDir, UploadChunk (+19 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (45): Actor, ActorContext, AgentEvent, AgentSupervisorHandle, Arc, Box, CancellationToken, Chip (+37 more)

### Community 20 - "Community 20"
Cohesion: 0.10
Nodes (30): AddRepoRequest, CloneStream, run(), ConeStats, ConeSuggestError, RepoManager, Repository, Request (+22 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (41): checkCommand(), eventNameForSubject(), onConcertoEvent(), RpcMethod, subscribe(), unsubscribe(), chunkToBytes(), createSession() (+33 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (43): Arc, Client, Option, Result, Self, Send, String, Sync (+35 more)
...
Cohesion: 0.10
Nodes (38): AgentKind, AgentSupervisorHandle, Arc, Decision, Option, Persistence, Request, Response (+30 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (37): Actor, ActorContext, Arc, AuditWriter, Config, Option, PathBuf, Persistence (+29 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (46): Display, Formatter, Option, PathBuf, Result, Self, String, Vec (+38 more)
...
Cohesion: 0.08
Nodes (31): callRpc(), ConeStats, estimateConeSize(), setCones(), invoke, getPullRequest(), createWorkarea(), CreateWorkareaOptions (+23 more)
...
Cohesion: 0.07
Nodes (39): Actor, ActorContext, Arc, Box, CheckRunSnapshot, CheckRunsSource, Config, Future (+31 more)

### Community 32 - "Community 32"
Cohesion: 0.10
Nodes (44): Arc, CheckRunSnapshot, CheckRunsSource, IssueProvider, IssueRef, IssueWriteBack, MergeMethod, MergeReport (+36 more)

### Community 33 - "Community 33"
Cohesion: 0.12
Nodes (34): Arc, CheckRun, Default, Deployment, E, HashMap, Inner, Mutex (+26 more)

### Community 34 - "Community 34"
Cohesion: 0.20
Nodes (29): ConePath, Path, Result, Vec, Path, PathBuf, String, TempDir (+21 more)

### Community 35 - "Community 35"
Cohesion: 0.12
Nodes (14): Arc, F, Into, Mutex, Option, Self, String, Vec (+6 more)
...
Cohesion: 0.08
Nodes (30): Attributes, Context, Debug, Error, Event, Id, Mutex, S (+22 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (40): CloneProgressEvent, cloneRepository(), onCloneProgress(), diffViewerSpy, invoke, repos, workarea, eventCallbacks (+32 more)

### Community 39 - "Community 39"
Cohesion: 0.09
Nodes (26): Arc, D, DeviceId, Endpoint, EndpointId, IrohTransport, JoinHandle, Mutex (+18 more)

### Community 40 - "Community 40"
Cohesion: 0.09
Nodes (38): ApiDispatcher, Box, EchoReply, EchoRequest, FirehoseRequest, FirehoseStream, Future, Loopback (+30 more)

### Community 41 - "Community 41"
Cohesion: 0.09
Nodes (38): AuthInterceptor, Arc, CancellationToken, Channel, DeviceCertIssuer, DeviceContext, IdentityError, Option (+30 more)
...
Cohesion: 0.11
Nodes (30): Arc, Request, Response, Result, RuntimeStatus, Self, Send, ServerCapabilities (+22 more)
...
Cohesion: 0.09
Nodes (59): adopt_resume_session(), AgentKind, AgentSupervisorConfig, AgentSupervisorHandle, build_path_policy(), bypass_for_session(), dispatch_parse_event(), emit_edit_mutex_blocked() (+51 more)
...
Nodes (65): if_, if_c<
  ...
  >::type, if_
        ...
        >::type, facebook(), isSizeEmpty(), rnscreens(), facebook(), facebook() (+57 more)
...
Cohesion: 0.07
Nodes (41): ChecksAggregator, Arc, CheckRun, IngestOutcome, Issue, IssueDetail, Option, Path (+33 more)

### Community 50 - "Community 50"
Cohesion: 0.16
Nodes (38): Error, HashSet, Option, RepositoryId, Result, SqliteConnection, SqlitePool, SqliteRow (+30 more)

### Community 51 - "Community 51"
Cohesion: 0.09
Nodes (40): civil_from_days(), civil_from_unix(), days_from_civil(), days_from_civil_round_trips(), JsonlFileSubscriber, OpenFile, parse_audit_date(), RotationConfig (+32 more)

### Community 52 - "Community 52"
Cohesion: 0.10
Nodes (20): Drop, Fn, Into, IpAddr, Option, Result, Self, String (+12 more)
...
Cohesion: 0.19
Nodes (15): Duration, PathBuf, Result, Self, TempDir, Core as Source of Truth, Single-instance PID-lock guard, PidFile (+7 more)
...
Cohesion: 0.10
Nodes (44): C, Formatter, Option, Path, Result, Sender, String, Vec (+36 more)

### Community 57 - "Community 57"
Cohesion: 0.09
Nodes (25): Arc, AtomicU64, CancellationToken, Error, Option, RelayError, Result, Self (+17 more)

### Community 58 - "Community 58"
Cohesion: 0.13
Nodes (31): Arc, CancellationToken, Endpoint, EndpointId, Mutex, RecvStream, RelayState, RelayUrl (+23 more)
...
Cohesion: 0.12
Nodes (23): IdentityError, Result, RevokedSet, Self, Send, String, Sync, Vec (+15 more)
...
Cohesion: 0.07
Nodes (37): formatError(), ListMcpResponse, listMcpServers(), McpServer, listSchedules(), ListSchedulesResponse, Schedule, listSkills() (+29 more)

### Community 63 - "Community 63"
Cohesion: 0.07
Nodes (35): BranchRef, AgentSupervisorHandle, Arc, CancellationToken, EditMutexRegistry, HashSet, IssueWriteBack, OneShotLlm (+27 more)

### Community 64 - "Community 64"
Cohesion: 0.11
Nodes (28): CompletePairingRequest, CompletePairingResponse, CoreInfo, Arc, DeviceManager, Error, PairingChallenge, PairingCoordinator (+20 more)

### Community 65 - "Community 65"
Cohesion: 0.15
Nodes (27): Arc, Option, Path, PathBuf, Persistence, Request, Response, Result (+19 more)
...
Cohesion: 0.16
Nodes (13): Arc, Mutex, Path, SqliteConnection, SqlitePool, DerefMut, Single-writer Queue + WAL, MutexGuard (+5 more)
...
Cohesion: 0.16
Nodes (27): ArchiveWorkareaRequest, Request, Response, Result, Self, Status, Workarea, WorkareaManager (+19 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (41): DiffHunk, DiffKind, DiffPayload, MergeProgress, Path, ProtoPullRequest, PullRequest, RevertReport (+33 more)

### Community 71 - "Community 71"
Cohesion: 0.13
Nodes (31): Arc, IdleSignal, NetSignal, Option, Path, PathBuf, Persistence, PowerSignal (+23 more)

### Community 72 - "Community 72"
Cohesion: 0.13
Nodes (28): Arc, AtomicUsize, CheckRunSnapshot, CheckRunsSource, Mutex, Option, PathBuf, Persistence (+20 more)
...
Cohesion: 0.01
Nodes (221): false_type, is_function<R(&&)()>, is_function<R(&&)(Arg1)>, is_function<R(&&)(Arg1, Arg2)>, is_function<R(&&)(Arg1, Arg2, Arg3)>, is_function<R(&&)(Arg1, Arg2, Arg3, Arg4)>, is_function<R(&&)(Arg1, Arg2, Arg3, Arg4, Arg5)>, is_rvalue_reference<R(&&)()> (+213 more)

### Community 76 - "Community 76"
Cohesion: 0.06
Nodes (34): Arc, CancellationToken, Channel, ClientKind, Connection, ConnectionPath, D, DeviceId (+26 more)

### Community 77 - "Community 77"
Cohesion: 0.08
Nodes (29): ArchiveOpts, AgentEvent, DiffPayload, IssueRef, Option, PrComposeContext, ProviderMergeReport, ProviderRevertReport (+21 more)

### Community 78 - "Community 78"
Cohesion: 0.15
Nodes (29): AgentKind, Arc, Handle, JoinHandle, Mutex, Notify, Option, Path (+21 more)

### Community 79 - "Community 79"
Cohesion: 0.14
Nodes (36): Actor, AgentSupervisorHandle, Arc, CancellationToken, DeviceCertIssuer, DeviceManager, Drop, IrohTransport (+28 more)

### Community 80 - "Community 80"
Cohesion: 0.14
Nodes (26): Display, Formatter, Into, Option, Result, Self, Send, String (+18 more)
...
Cohesion: 0.08
Nodes (31): Arc, CheckRun, Error, HashMap, Issue, Mutex, NowSecs, Option (+23 more)

### Community 84 - "Community 84"
Cohesion: 0.10
Nodes (23): Client, Issue, Option, Result, SecretValue, Self, String, Vec (+15 more)
...
Cohesion: 0.10
Nodes (21): DiffHunk, DiffKind, DiffPayload, FileDiff, getWorkareaRepoDiff(), CodePrRegionProps, CodePrSubTab, DiffViewer() (+13 more)

### Community 88 - "Community 88"
Cohesion: 0.15
Nodes (23): AsRef, Debug, Drop, Error, File, Formatter, Option, Path (+15 more)
...
Cohesion: 0.17
Nodes (26): Arc, FakeGitHub, Option, Persistence, RepositoryId, Result, String, TempDir (+18 more)
...
Cohesion: 0.07
Nodes (32): ApiDispatcher, Arc, Box, Channel, EchoReply, EchoRequest, FirehoseRequest, FirehoseStream (+24 more)

### Community 96 - "Community 96"
Cohesion: 0.17
Nodes (15): PathBuf, TempDir, Persistence, TempDir, WorkareaId, WorkspaceId, SqliteConnectOptions, fresh_db_boots_and_migrates() (+7 more)

### Community 97 - "Community 97"
Cohesion: 0.13
Nodes (24): run(), Request, Response, Result, SchedulerHandle, Self, Status, Timestamp (+16 more)

### Community 98 - "Community 98"
Cohesion: 0.11
Nodes (37): Arc, DeviceCertIssuer, DeviceContext, Option, PairingRequest, Persistence, Request, Result (+29 more)
...
Cohesion: 0.12
Nodes (33): adopt_orphans(), cold_path_one(), concerto_persist::Session, FinalInfo, find_cold_candidates(), find_session_by_socket(), _hint_arc(), mark_crashed() (+25 more)
...
Cohesion: 0.07
Nodes (46): Arc, CheckRun, CreatePrRequest, Deployment, Error, Into, Issue, MergeMethod (+38 more)
...
Cohesion: 0.18
Nodes (27): Error, Option, RepositoryId, Result, SqliteConnection, SqlitePool, SqliteRow, String (+19 more)
...
Cohesion: 0.13
Nodes (16): Concerto Architecture Overview, Local-First Orchestration Platform, Locked Architectural Decisions, MIT Licensing Posture, Git-URL Marketplace Format, SkillRegistrySource trait (extension seam), Skill Visibility Overrides, LLM-ranked Mode (pluggable provider) (+8 more)

### Community 109 - "Community 109"
Cohesion: 0.14
Nodes (19): Arc, CancellationToken, IrohTransport, Option, Path, PathBuf, Result, Runtime (+11 more)
...
Cohesion: 0.08
Nodes (40): BandwidthLimiter, ConeSuggesterSeam, Actor, ActorContext, Arc, AuditWriter, CloneStrategy, ConePath (+32 more)
...
Cohesion: 0.11
Nodes (23): HashMap, Instant, Option, SocketAddr, String, Vec, RelayInner, BandwidthCounter (+15 more)

### Community 116 - "Community 116"
Cohesion: 0.14
Nodes (23): CancellationToken, Connection, Endpoint, Error, Relay, RelayConfig, RelayUrl, Result (+15 more)
...
Cohesion: 0.05
Nodes (49): ApiDispatcher, Arc, Box, CoreClient, CoreClientError, Endpoint, EndpointAddr, Future (+41 more)

### Community 120 - "Community 120"
Cohesion: 0.19
Nodes (16): Arc, Channel, CoreClientError, Fn, JoinHandle, PathBuf, Result, Self (+8 more)

### Community 121 - "Community 121"
Cohesion: 0.15
Nodes (16): AtomicU32, Arc, AuditEvent, AuditLogSubscriber, Path, PathBuf, Vec, CountingSubscriber (+8 more)

### Community 122 - "Community 122"
Cohesion: 0.15
Nodes (22): Client, HashMap, M, Path, PathBuf, RunningCore, SocketAddr, String (+14 more)

### Community 123 - "Community 123"
Cohesion: 0.15
Nodes (27): Arc, AuditEvent, AuditWriter, DeviceManager, Instant, KeyPair, Mutex, Persistence (+19 more)

### Community 124 - "Community 124"
Cohesion: 0.19
Nodes (20): Arc, Option, Path, PathBuf, Persistence, TempDir, WorkareaId, WorktreeResolver (+12 more)

### Community 125 - "Community 125"
Cohesion: 0.17
Nodes (17): Actor, ActorContext, Arc, AtomicUsize, Config, Persistence, Result, AlwaysPanic (+9 more)
...
Cohesion: 0.02
Nodes (62): apply<Set,typename Pos::type>, set0, apply, clear_impl< aux::set_tag >, apply, erase_impl< aux::set_tag >, apply, has_key_impl< aux::set_tag > (+54 more)
...
Cohesion: 0.23
Nodes (20): Option, RepositoryId, Result, SessionId, SqliteConnection, SqlitePool, SqliteRow, String (+12 more)
...
Cohesion: 0.22
Nodes (20): colocated_found_when_no_override(), default_host_binary(), deps_ancestor_found_when_not_colocated(), empty_override_is_ignored(), error_lists_tried_paths_and_env_override(), host_bin_filename(), override_wins_over_colocated(), resolve_host_binary() (+12 more)

### Community 135 - "Community 135"
Cohesion: 0.15
Nodes (14): run_worker(), SyslogSubscriber, SyslogTransport, AuditEvent, AuditLogSubscriber, Drop, Into, JoinHandle (+6 more)

### Community 136 - "Community 136"
Cohesion: 0.21
Nodes (14): AuditLogSubscriber, AuditWriter, AuditWriterTask, Arc, AuditEvent, CancellationToken, JoinHandle, Notify (+6 more)

### Community 137 - "Community 137"
Cohesion: 0.17
Nodes (16): Request, Response, Result, Self, SkillRow, SkillsRegistryHandle, Status, skill_to_proto() (+8 more)

### Community 138 - "Community 138"
Cohesion: 0.21
Nodes (20): AgentSupervisorHandle, Arc, Path, PathBuf, Persistence, SessionId, String, TempDir (+12 more)

### Community 139 - "Community 139"
Cohesion: 0.16
Nodes (11): Arc, PathBuf, Persistence, TempDir, WorkareaId, host_bin(), list_by_session_returns_inserted_rows(), make_persistence() (+3 more)
...
Cohesion: 0.04
Nodes (66): AuthObserverInner, Arc, Box, CancellationToken, Connection, D, Endpoint, EndpointId (+58 more)

### Community 142 - "Community 142"
Cohesion: 0.15
Nodes (14): Issue, Option, String, Value, Vec, JiraFields, JiraStatus, flatten_adf() (+6 more)

### Community 143 - "Community 143"
Cohesion: 0.13
Nodes (14): HttpsForwarderSubscriber, run_worker(), AuditEvent, AuditLogSubscriber, Client, Drop, Into, JoinHandle (+6 more)

### Community 144 - "Community 144"
Cohesion: 0.17
Nodes (9): BandwidthCounter, Instant, Option, Self, SocketAddr, EndpointRoute, ForwardOutcome, RegisterOutcome (+1 more)

### Community 145 - "Community 145"
Cohesion: 0.21
Nodes (19): Arc, Path, PathBuf, Persistence, String, TempDir, Vec, WorkareaManager (+11 more)

### Community 146 - "Community 146"
Cohesion: 0.14
Nodes (16): Duration, Event, NatStats, NatStatsSource, Option, S, Sender, TempDir (+8 more)

### Community 147 - "Community 147"
Cohesion: 0.22
Nodes (19): Arc, Map, Persistence, String, TempDir, Value, WorkareaId, WorkareaManager (+11 more)
...
Cohesion: 0.17
Nodes (13): Option, Send, String, Sync, Vec, decode_hex(), IngestOutcome, parse_event() (+5 more)
...
Nodes (185): and_impl<
  ...
  >, false_, is_le, or_impl<
          BOOST_MPL_AUX_NESTED_TYPE_WKND(T1)::value
        , T2, T3, T4, T5
        >, is_lambda_expression, lambda (+177 more)

### Community 153 - "Community 153"
Cohesion: 0.15
Nodes (22): allowed_passes_through(), classify_policy_for_path(), classify_policy_for_path_is_publicly_callable(), denied_overrides_resolver(), outside_returns_outside(), passthrough_when_no_path_extracted(), policy_override(), PolicyVerdict (+14 more)
...
Cohesion: 0.20
Nodes (10): Default, Self, Vec, VecDeque, Chunk, eviction_drops_oldest_when_capacity_exceeded(), prune_through_removes_acked_chunks(), push_assigns_monotonic_seq() (+2 more)

### Community 157 - "Community 157"
Cohesion: 0.16
Nodes (15): Chip, Request, Response, Result, Self, Status, SuggestionEngineHandle, GetSuggestionsRequest (+7 more)

### Community 158 - "Community 158"
Cohesion: 0.08
Nodes (20): SessionComposer(), SessionComposerProps, AutoUpdateToast(), FirstRunClaudeToast(), AutoUpdateState, useAutoUpdate(), react, queryClient (+12 more)

### Community 159 - "Community 159"
Cohesion: 0.18
Nodes (13): AgentEvent, Chip, Default, Option, Regex, Self, SuggestionRule, WorkareaId (+5 more)

### Community 160 - "Community 160"
Cohesion: 0.27
Nodes (18): Arc, Persistence, String, TempDir, WorkareaId, WorkareaManager, apply_session_event_maps_started_awaiting_resumed_crashed(), apply_session_event_only_finishes_when_no_live_session_remains() (+10 more)

### Community 161 - "Community 161"
Cohesion: 0.26
Nodes (18): Arc, Path, PathBuf, Persistence, RepoManager, RepositoryId, String, TempDir (+10 more)

### Community 162 - "Community 162"
Cohesion: 0.13
Nodes (22): Display, ProgressSink, Self, CloneStrategy, Option, Path, String, TempDir (+14 more)

### Community 163 - "Community 163"
Cohesion: 0.22
Nodes (18): NewPullRequest, Option, PullRequest, RepositoryId, Result, SqliteConnection, SqlitePool, SqliteRow (+10 more)
...
Cohesion: 0.08
Nodes (20): ClassTypeTransform, components, components_bcc, components_bcc<typename remove_cv<T>::type,T,
            ClassTypeTransform>(), components_impl, vector<
          na, na, na, na, na, na, na, na, na, na, na, na, na, na, na, na, na
        , na, na, na
        >, apply, clear_impl< aux::vector_tag > (+12 more)

### Community 166 - "Community 166"
Cohesion: 0.24
Nodes (14): AuthObserver, ActorContext, ApiDispatcher, Box, Config, Future, NoiseDuplex, Output (+6 more)

### Community 167 - "Community 167"
Cohesion: 0.25
Nodes (17): CoreUnderTest, Path, String, TempDir, Vec, archive_sets_status_and_timestamp(), create_workarea_lays_out_disk_and_db(), git() (+9 more)
...
Cohesion: 0.24
Nodes (16): Error, Into, Option, Status, String, IdentityError, map_validate_err(), auth_invalid_cert_status() (+8 more)

### Community 172 - "Community 172"
Cohesion: 0.24
Nodes (16): AgentEvent, Arc, Duration, PathBuf, Persistence, Receiver, TempDir, Vec (+8 more)

### Community 173 - "Community 173"
Cohesion: 0.24
Nodes (16): AgentEvent, Arc, Duration, F, PathBuf, Persistence, Receiver, TempDir (+8 more)

### Community 174 - "Community 174"
Cohesion: 0.24
Nodes (15): Arc, Persistence, SessionId, TempDir, WorkareaId, concurrent_read_does_not_block_during_write(), guard_release_on_drop_lets_later_write_succeed(), open_persistence() (+7 more)

### Community 175 - "Community 175"
Cohesion: 0.18
Nodes (20): run(), CoreUnderTest, Path, PathBuf, String, TempDir, CreateWorkareaRequest, attach_second_repo() (+12 more)
...
Cohesion: 0.30
Nodes (14): Path, String, TempDir, clone_full(), clone_full_streams_progress(), clone_full_writes_a_git_dir(), fetch_succeeds_on_clean_clone(), git() (+6 more)
...
Cohesion: 0.21
Nodes (15): D, Error, Ok, Option, Result, S, Timestamp, Value (+7 more)

### Community 180 - "Community 180"
Cohesion: 0.26
Nodes (15): chat_id_for_session(), CheckpointRecord, create_checkpoint_for_workarea(), insert_turn_message(), now_unix_ms(), revert_workarea_to_checkpoint(), Option, Persistence (+7 more)

### Community 181 - "Community 181"
Cohesion: 0.21
Nodes (6): extract_path(), extract_path_field(), extract_path_from_command(), Option, PathBuf, Value

### Community 182 - "Community 182"
Cohesion: 0.23
Nodes (15): col_width(), discover_all_workareas(), render(), run(), SessionRow, Channel, CommandError, Item (+7 more)
...
Cohesion: 0.08
Nodes (29): ManagedPolicy, Option, Path, Persistence, Result, Self, SessionId, auto_decision_string_mirrors_mode() (+21 more)

### Community 185 - "Community 185"
Cohesion: 0.33
Nodes (15): Arc, Path, PathBuf, Persistence, Result, Vec, WorkareaId, WorkspaceId (+7 more)

### Community 186 - "Community 186"
Cohesion: 0.23
Nodes (11): Arc, AuditEvent, AuditLogSubscriber, Mutex, Self, Vec, daily_rotation_opens_new_file_when_clock_crosses_midnight(), drop_on_full_does_not_block_producers() (+3 more)

### Community 187 - "Community 187"
Cohesion: 0.17
Nodes (21): Arc, ConePath, ConeSuggester, Path, PathBuf, Persistence, RepoManager, RepositoryId (+13 more)

### Community 188 - "Community 188"
Cohesion: 0.25
Nodes (15): Arc, NewPullRequest, Persistence, RepositoryId, TempDir, Vec, WorkareaId, WorkareaManager (+7 more)

### Community 189 - "Community 189"
Cohesion: 0.23
Nodes (15): Option, Result, SkillFilter, SkillId, SkillRow, SqliteConnection, SqlitePool, SqliteRow (+7 more)

### Community 190 - "Community 190"
Cohesion: 0.28
Nodes (15): Option, Result, SessionId, SqliteConnection, SqlitePool, SqliteRow, String, Vec (+7 more)

### Community 191 - "Community 191"
Cohesion: 0.30
Nodes (15): NewPullRequest, Persistence, RepositoryId, TempDir, Vec, WorkareaId, columns_round_trip(), fresh_db() (+7 more)
...
Cohesion: 0.13
Nodes (20): AuditActor, AuditEvent, AuditKind, EntityKind, SubjectRef, AuditActor, AuditKind, Error (+12 more)

### Community 195 - "Community 195"
Cohesion: 0.27
Nodes (14): Arc, Option, Path, Persistence, RepoManager, String, TempDir, add_persists_real_strategy_and_clone_routes_through_it() (+6 more)

### Community 196 - "Community 196"
Cohesion: 0.25
Nodes (13): CoreUnderTest, Duration, Path, S, String, TempDir, drain_for_message(), echo_session_streams_message_and_marks_finished() (+5 more)

### Community 197 - "Community 197"
Cohesion: 0.27
Nodes (14): CoreUnderTest, Duration, Event, Option, Path, S, String, ack_prunes_then_old_since_offset_yields_gap_detected() (+6 more)

### Community 198 - "Community 198"
Cohesion: 0.23
Nodes (14): Arc, Path, PathBuf, Persistence, RepositoryId, TempDir, WorkareaId, auth_status_failure_returns_typed_error() (+6 more)

### Community 199 - "Community 199"
Cohesion: 0.23
Nodes (14): Path, PathBuf, Result, Vec, empty_input_is_clean(), parse_porcelain_v1(), parses_added_and_deleted(), parses_modified_and_untracked() (+6 more)
...
Cohesion: 0.26
Nodes (12): bench_8agents_memory(), git(), make_bare_with_commit(), read_rss_kb(), seed(), Seeded, CoreUnderTest, Criterion (+4 more)

### Community 206 - "Community 206"
Cohesion: 0.34
Nodes (13): BufReader, Path, R, Result, Sender, String, Hybrid gix/git2/shell-out Git stack, Output (+5 more)

### Community 207 - "Community 207"
Cohesion: 0.26
Nodes (13): col_width(), render(), render_permission_mode(), run(), WorkspaceRow, CommandError, Item, Iterator (+5 more)
...
Cohesion: 0.27
Nodes (9): Actor, Arc, PathBuf, Persistence, Self, SkillsRegistryHandle, SkillsRegistryActor, SkillsRegistryConfig (+1 more)
...
Cohesion: 0.16
Nodes (9): Decision, PermissionMode, Vec, allow_yolo_false_blocks_yolo(), deny_list_still_applies_in_yolo(), full_matrix_4_modes_x_3_classes(), managed_cap_auto_blocks_yolo(), matrix() (+1 more)

### Community 215 - "Community 215"
Cohesion: 0.24
Nodes (11): DeviceCert, known_answer_cert_bytes_are_frozen(), known_answer_signature_is_frozen(), non_canonical_trailing_garbage_fails_even_with_valid_sig(), print_known_answer_vector(), public_key_from_cert_core_pubkey_is_usable(), sign_then_verify_happy_path(), single_bit_tamper_in_body_fails() (+3 more)
...
Cohesion: 0.14
Nodes (25): E, IdentityError, Instant, NoiseSession, NoiseStatic, Receiver, Result, Vec (+17 more)
...
Cohesion: 0.31
Nodes (12): CoreUnderTest, Path, String, TempDir, archive_workarea_default_keeps_worktree_on_disk(), archive_workarea_remove_worktree_blows_disk_away(), archive_workspace_cascades_to_all_workareas(), git() (+4 more)
...
Cohesion: 0.33
Nodes (12): Arc, PathBuf, Persistence, TempDir, WorkareaId, create_schedule_rejects_short_interval(), fire_now_creates_run_row_when_supervisor_missing(), inflight_suppression_skips_overlapping_fire() (+4 more)
...
Cohesion: 0.26
Nodes (12): LocalCoreIssuer, PairingRequest, SignedDeviceCert, Vec, cert_from_a_different_core_is_rejected(), garbage_bytes_return_err_never_panic(), issue_then_validate_happy_path(), make_issuer() (+4 more)

### Community 229 - "Community 229"
Cohesion: 0.22
Nodes (9): Display, Error, Formatter, From, IdentityError, Result, Self, std::io::Error (+1 more)

### Community 230 - "Community 230"
Cohesion: 0.27
Nodes (10): format_uptime(), render(), run(), StatusView, CommandError, OutputFormat, Path, Result (+2 more)

### Community 231 - "Community 231"
Cohesion: 0.33
Nodes (11): HostFrame, R, Result, W, PTY Subprocess Agent Backend (portable-pty), eof_on_clean_close(), FrameError, read_frame() (+3 more)

### Community 232 - "Community 232"
Cohesion: 0.21
Nodes (12): Command, CommandError, ExitCode, Option, PathBuf, Result, Cli, Command (+4 more)

### Community 233 - "Community 233"
Cohesion: 0.10
Nodes (14): TransportKind, CancellationToken, JoinHandle, Receiver, Result, Sender, classify_tool(), install() (+6 more)

### Community 234 - "Community 234"
Cohesion: 0.26
Nodes (8): AgentEvent, Chip, Option, SuggestionRule, WorkareaId, WorkareaState, AgentCrashedRule, now_unix_ms()

### Community 235 - "Community 235"
Cohesion: 0.26
Nodes (8): AgentEvent, Chip, Option, SuggestionRule, WorkareaId, WorkareaState, CommitUncommittedRule, now_unix_ms()

### Community 236 - "Community 236"
Cohesion: 0.26
Nodes (8): AgentEvent, Chip, Option, SuggestionRule, WorkareaId, WorkareaState, Context50Rule, now_unix_ms()

### Community 237 - "Community 237"
Cohesion: 0.26
Nodes (8): AgentEvent, Chip, Option, SuggestionRule, WorkareaId, WorkareaState, Context80Rule, now_unix_ms()
...
Cohesion: 0.35
Nodes (11): F, PathBuf, String, TempDir, file_layer_emits_json_lines(), passes_through_non_secret_fields(), read_to_string(), redacts_blocklisted_event_field() (+3 more)
...
Cohesion: 0.12
Nodes (33): AsyncRead, AsyncWrite, ChannelTag, Connected, ConnectInfo, Context, Error, Future (+25 more)
...
Cohesion: 0.27
Nodes (10): Path, Result, String, Vec, FinalInfo, tail_handles_short_input(), tail_lines(), tail_returns_last_n_lines() (+2 more)
...
Cohesion: 0.02
Nodes (66): bool_, has_const_time_erase, has_const_time_insert, has_native_replace, has_stable_iterators, is_interoperable, apply, AUX778076_OP_IMPL_NAME<integral_c_tag,integral_c_tag> (+58 more)

### Community 248 - "Community 248"
Cohesion: 0.27
Nodes (10): ExitCode, RelayError, Result, main(), WssTlsConfig, E2EE Relay (ciphertext-only data plane), Self-hosted Relay Binary, build_wss_tls() (+2 more)

### Community 249 - "Community 249"
Cohesion: 0.24
Nodes (5): ChannelTag, Result, Logical Channel Tags (0x01-0x04), ChannelTag, tag_from_byte()

### Community 250 - "Community 250"
Cohesion: 0.03
Nodes (101): deque, deque<
          na, na, na, na, na, na, na, na, na, na, na, na, na, na, na, na, na
        , na, na, na
        >, deque<
...
Cohesion: 0.18
Nodes (10): content, type, version, fields, description, labels, status, summary (+2 more)

### Community 252 - "Community 252"
Cohesion: 0.18
Nodes (10): data, issue, description, identifier, labels, state, title, url (+2 more)

### Community 253 - "Community 253"
Cohesion: 0.02
Nodes (117): _dc_imp, Ret, _ret_imp, any, BOOST_JOIN, BOOST_TT_TRAIT_NAME, BOOST_TT_TRAIT_NAME<T, U, boost::binary_op_detail::dont_care>, BOOST_TT_TRAIT_NAME<T, U, void> (+109 more)

### Community 254 - "Community 254"
Cohesion: 0.02
Nodes (65): facebook(), facebook(), facebook(), facebook(), facebook(), facebook(), facebook(), Node (+57 more)

### Community 255 - "Community 255"
Cohesion: 0.22
Nodes (7): call(), CommandError, OutputFormat, F, Result, Self, T

### Community 256 - "Community 256"
Cohesion: 0.19
Nodes (17): Option, Path, PathBuf, Result, String, DefaultGuard, build_filter(), default_filter_when_env_unset() (+9 more)
...
Cohesion: 0.36
Nodes (8): Path, String, git(), git_stdout(), have_sparse_checkout(), index_is_sparse(), status_on_fresh_cone_reports_only_in_cone(), status_on_restored_prepacked_fixture()
...
Cohesion: 0.22
Nodes (10): Concerto PRD, Concerto Chat / Maestro Agent, Monorepo Support (sparse/blobless/sparse-index), Multi-repo Workspaces & Multi-PR Sessions, Skill Explorer, Smart Suggestion Chips, Workflow Explorer (/loop + scheduled tasks), Workspace Primitive (git worktree) (+2 more)
...
Cohesion: 0.02
Nodes (102): disable_if, disable_if_memtransfer_copy_assignable, disable_if_memtransfer_copy_constructible, disable_if_single_value_proxy, BOOST_MOVE_FORCEINLINE, add_const, add_const_lvalue_reference, add_const<T&> (+94 more)

### Community 270 - "Community 270"
Cohesion: 0.50
Nodes (8): Path, Result, .context/ directory, apply(), apply_creates_full_layout(), apply_is_idempotent(), apply_preserves_existing_contentful_prompt(), file_has_contents()

### Community 271 - "Community 271"
Cohesion: 0.42
Nodes (8): Path, TempDir, git(), lists_nested_dir_children_with_full_paths(), lists_root_children_trees_first(), make_repo(), trailing_and_leading_slashes_are_tolerated(), unknown_ref_is_an_error()

### Community 272 - "Community 272"
Cohesion: 0.42
Nodes (8): Persistence, RepositoryId, TempDir, WorkareaId, fresh_db(), get_workarea_repo_cones_absent_pair_is_none(), seed(), workarea_repo_cones_default_empty_then_round_trip()

### Community 273 - "Community 273"
Cohesion: 0.02
Nodes (62): and_, iterator_difference, not_, range_difference<BOOST_DEDUCED_TYPENAME remove_reference<T>::type>, enable_type, is_convertible<use_default,To>, iterator_adaptor_base, type (+54 more)

### Community 274 - "Community 274"
Cohesion: 0.31
Nodes (5): Connection, ConnectionPath, IpAddr, classify_path(), is_lan_addr()

### Community 275 - "Community 275"
Cohesion: 0.36
Nodes (8): Arc, GithubNowSecs, SyntheticClock, caches_token_across_calls_no_remint(), clock_now(), mints_installation_token_and_calls_with_it(), refreshes_token_when_synthetic_clock_passes_expiry(), rejects_malformed_private_key()

### Community 276 - "Community 276"
Cohesion: 0.22
Nodes (9): QR Pairing Scanner, Connect-Web Transport Adapter, Ephemeral Phone-mediated Pairing, IndexedDB Key/Cert Storage, LAN-direct Path (loopback/mDNS), Subscription Multiplexer (since_offset replay), Web Client (SPA), WSS-through-relay Bridge (+1 more)

### Community 277 - "Community 277"
Cohesion: 0.43
Nodes (7): String, delete_missing_is_idempotent(), delete_then_get_returns_none(), missing_key_returns_none(), overwrite_returns_new_value(), set_then_get_returns_same_value(), unique_service()

### Community 278 - "Community 278"
Cohesion: 0.43
Nodes (7): Option, Result, SqliteConnection, String, insert(), NewChatMessage, soft_delete_after()

### Community 279 - "Community 279"
Cohesion: 0.32
Nodes (6): MdnsBrowser, Option, DiscoveredCore, discover_until(), opt_out_suppresses_publication(), publish_and_browse_round_trip_exact_txt_schema()
...
Cohesion: 0.52
Nodes (6): aead_roundtrip(), bench_second_aead(), establish_pair(), Criterion, Instant, NoiseSession

### Community 282 - "Community 282"
Cohesion: 0.52
Nodes (6): bench_status(), build_fixture(), git(), Criterion, Path, TempDir

### Community 283 - "Community 283"
Cohesion: 0.29
Nodes (6): Option, String, Vec, AgentKind, FinalInfo, HostFrame

### Community 284 - "Community 284"
Cohesion: 0.02
Nodes (49): facebook(), facebook(), facebook(), facebook(), DisplayType, facebook(), facebook(), namespace (+41 more)
...
Cohesion: 0.52
Nodes (6): Persistence, TempDir, action_prefs_json_defaults_to_empty_object_on_every_select(), action_prefs_json_round_trips_explicit_value(), fresh_db(), seed_repo()
...
Cohesion: 0.06
Nodes (39): ordered_index_node_impl_base, color_ref, const_impl_pointer, black_count(), ordered_index_node, ordered_index_node_compressed_base, parentcolor_, ordered_index_node_impl (+31 more)

### Community 291 - "Community 291"
Cohesion: 0.29
Nodes (6): body, html_url, labels, number, state, title

### Community 292 - "Community 292"
Cohesion: 0.29
Nodes (6): data, issue, id, team, nodes, states

### Community 293 - "Community 293"
Cohesion: 0.29
Nodes (6): _comment, limit, remaining, reset, resource, used
...
Cohesion: 0.20
Nodes (15): Arc, FakeGitHub, Value, VcsProvider, Provider, provider_slug(), check_runs_cache_ttl_refetch(), check_runs_emits_opaque_frame() (+7 more)
...
Cohesion: 0.47
Nodes (4): String, WorkareaId, Chip, ChipAction
...
Cohesion: 0.47
Nodes (5): FnMut, Instant, core_bin(), second_instance_exits_zero_first_instance_cleans_pid_on_sigterm(), wait_until()

### Community 302 - "Community 302"
Cohesion: 0.40
Nodes (4): From, Self, Status, Error

### Community 303 - "Community 303"
Cohesion: 0.40
Nodes (4): Error, From, Self, SecretsError

### Community 304 - "Community 304"
Cohesion: 0.02
Nodes (110): apply, BOOST_TESTED_AT, Deref, __IBMCPP__, is_same, iter_fold_if_impl<
          first_
        , State
        , ForwardOp
        ...
        , BackwardOp
        , backward_pred_
        >, class_transform, class_transform< T, add_pointer<_> > (+102 more)

### Community 305 - "Community 305"
Cohesion: 0.33
Nodes (5): data, resolveReviewThread, thread, id, isResolved
...
Cohesion: 0.17
Nodes (12): Any, Box, Config, F, Result, Send, String, Actor (+4 more)

### Community 312 - "Community 312"
Cohesion: 0.60
Nodes (4): ExitCode, Result, main(), run()

### Community 313 - "Community 313"
Cohesion: 0.40
Nodes (3): Option, String, WorkareaState
...
Cohesion: 0.70
Nodes (4): Result, SqliteConnection, insert_delivery_if_absent(), prune_expired()
...
Cohesion: 0.60
Nodes (5): Active State Indicator, Desktop Application, Tray Active Icon, Menu Bar Tray Icon, Monochrome Template Image

### Community 319 - "Community 319"
Cohesion: 0.50
Nodes (5): Desktop App, Tray Inactive Icon, Inactive State, Menu Bar Tray Icon, Monochrome Glyph Style

### Community 321 - "Community 321"
Cohesion: 0.03
Nodes (73): detail::if_true<
      ...
      >, is_function, is_member_function_pointer, is_pointer_to_class (+65 more)
...
Nodes (39): fold, fold<
    ...
    MplSet,
    duplicate_tag_marker>, reverse_fold, copy_impl, reverse_copy_impl, apply, remove_if_helper, remove_if_impl (+31 more)
...
Cohesion: 0.83
Nodes (3): embedded-core Cargo Feature, identifier, productName

### Community 325 - "Community 325"
Cohesion: 0.50
Nodes (3): data, issueUpdate, success

### Community 326 - "Community 326"
Cohesion: 0.50
Nodes (3): merged, message, sha
...
Cohesion: 0.26
Nodes (9): CoreUnderTest, String, create_get_list_archive_workspace(), duplicate_repo_rejected(), multi_repo_create_persists_positions(), register_repo(), slug_collision_auto_suffix(), spec() (+1 more)
...
Cohesion: 0.13
Nodes (19): Default, Duration, Error, MergeMethod, ProgressSink, String, Per-workarea Implicit PR Set, Three-layer Settings Precedence (+11 more)

### Community 371 - "Community 371"
Cohesion: 0.15
Nodes (21): AgentEvent, Chip, Event, Option, Timestamp, WorkareaEvent, map_agent_event(), map_pr_set_event() (+13 more)
...
Cohesion: 0.44
Nodes (7): Self, duplicate_actor_name_rejected(), err_return_also_restarts_then_fails(), panic_triggers_restart_then_failed(), peer_actor_unaffected_by_neighbor_panic(), spawn_and_shutdown_cleanly(), test_persistence()

### Community 374 - "Community 374"
Cohesion: 0.40
Nodes (5): A, AtomicUsize, Fn, Sync, counted_factory()
...
Cohesion: 0.01
Nodes (110): Base, facebook(), facebook(), facebook(), facebook(), facebook(), facebook(), facebook() (+102 more)
...
Cohesion: 0.04
Nodes (49): run(), run(), run(), run(), run(), run(), run(), run() (+41 more)
...
Cohesion: 0.02
Nodes (55): facebook(), ParagraphAttributes, namespace, facebook(), namespace, facebook(), namespace, facebook() (+47 more)
...
Cohesion: 0.03
Nodes (41): facebook(), LayoutMetrics, facebook(), facebook(), namespace, facebook(), namespace, facebook() (+33 more)
...
Nodes (42): eval_if, if_c<
        ...
        >::type, set_insert_impl<
              Set
            , typename if_na<KeyOrNA,PosOrKey>::type
            >, apply, erase_key_impl< aux::set_tag >, apply, insert_impl< aux::set_tag >, set_insert_impl (+34 more)
...
Cohesion: 0.05
Nodes (50): flattenDiff(), FlattenOptions, PLAIN, tokenCache, tokensFor(), FileAcc, HunkAcc, parseUnifiedDiff() (+42 more)
...
Cohesion: 0.06
Nodes (56): Bench, Args, bench_iroh_direct(), bench_iroh_relay(), bench_uds(), init_tracing(), main(), measure() (+48 more)
...
Cohesion: 0.04
Nodes (62): set1, set10, set11, set12, set13, set14, set15, set16 (+54 more)
...
Cohesion: 0.16
Nodes (17): represents_impl<Tag,  PropertyTag>, bits, changed_tag, compound_tag, encode_bits_impl, extract, has_const_property_tag, has_cv_property_tag (+9 more)

### Community 432 - "Community 432"
Cohesion: 0.08
Nodes (57): Archive, BOOST_CATCH_END, BOOST_DEDUCED_TYPENAME, allocate_node(), BOOST_CATCH(), BOOST_NOEXCEPT(), BOOST_TRY(), check_invariant_() (+49 more)
...
Cohesion: 0.04
Nodes (43): disable_if<boost::is_arithmetic<T> >, enable_if, if_c<
    is_const<Type>::value,
  ...
  >::type, enable_if_memtransfer_copy_assignable, enable_if_memtransfer_copy_constructible, enable_if_single_value_proxy, BOOST_GPU_ENABLED (+35 more)
...
Cohesion: 0.08
Nodes (44): Allocator, allocator_type, Archive, BOOST_COPYABLE_AND_MOVABLE, BOOST_NOEXCEPT(), check_invariant_(), clear_(), copy_construct_from() (+36 more)
...
Cohesion: 0.14
Nodes (37): build_client_endpoint(), build_server_addr(), decode_pub(), decode_token(), files_round_trip(), random_32(), stream_opens(), CertInterceptorFactory (+29 more)
...
Cohesion: 0.05
Nodes (22): cdp(), Option, Value, Option, Json, DestructiveMatch, is_destructive(), matches() (+14 more)

### Community 470 - "Community 470"
Cohesion: 0.04
Nodes (49): cpp0x_result_of<F(Args...)>, cpp0x_result_of<F(BOOST_RESULT_OF_ARGS)>, make_slist_base_hook, make_slist_member_hook, slist_base_hook, slist_member_hook, eval_if, eval_if_c (+41 more)
...
Cohesion: 0.05
Nodes (29): select_uniform_01<UniformRandomNumberGenerator>::BOOST_NESTED_TEMPLATE apply<RealType>::type, Engine, apply, backward_compatible_uniform_01, _factor, _rng, new_uniform_01, operator()() (+21 more)
...
Cohesion: 0.11
Nodes (38): iterator_range_base<
                    IteratorT,
                    BOOST_DEDUCED_TYPENAME iterator_range_detail::pure_iterator_traversal<IteratorT>::type
                >, BOOST_DEDUCED_TYPENAME, ForwardRange, IntegerT, Iterator, Iterator1T, Iterator2T, IteratorT (+30 more)
...
Cohesion: 0.11
Nodes (40): files_step(), stream_step(), Ascii, CertInterceptorFactory, Channel, Clone, Endpoint, EndpointAddr (+32 more)
...
Cohesion: 0.05
Nodes (39): `crates/persist/src/api.rs`, enum `SkillScope`, struct `NewChat`, struct `NewPullRequest`, struct `NewRepository`, struct `NewSchedule`, struct `NewScheduleRun`, struct `NewSession` (+31 more)
...
Cohesion: 0.08
Nodes (29): Args, main(), Args, handle_connection(), main(), report_home_relay(), Incoming, RelayChoice (+21 more)
...
Cohesion: 0.07
Nodes (34): at <typename S::types, N >, back <typename S::types>, begin <typename S::types>, empty <typename S::types>, end <typename S::types>, front <typename S::types>, S, size <typename S::types> (+26 more)
...
Cohesion: 0.06
Nodes (33): move_detail::
      make_unsigned<typename iter_difference<T>::type >, bidirectional_iterator_tag, contiguous_iterator_tag, forward_iterator_tag, iter_category, iter_category<T*>, iter_difference, iter_difference<T*> (+25 more)

### Community 556 - "Community 556"
Cohesion: 0.06
Nodes (19): noncopyable, header_holder, member, NodeTypePtr, scoped_bilock, lock1, lock2, mutex_eq (+11 more)

### Community 557 - "Community 557"
Cohesion: 0.06
Nodes (34): Collapse Project → Workspace — Implementation Plan, Conventions for this plan, Phase 0 — Schema rewrite (migrations), Phase 1 — Persistence layer (`crates/persist`), Phase 2 — Proto contract (`crates/proto`), Phase 3 — Core managers, handlers, settings, permission (`crates/core`), Phase 4 — Desktop (`apps/desktop`), Phase 5 — Documentation (+26 more)

### Community 558 - "Community 558"
Cohesion: 0.09
Nodes (21): backgroundColor(), barTintColor(), color(), largeTitleBackgroundColor(), largeTitleColor(), navigationBarColor(), statusBarColor(), tabBarBackgroundColor() (+13 more)
...
Cohesion: 0.10
Nodes (25): bidirectional_iterator_helper, random_access_iterator_helper, Base, Class, Derived, advance(), apply, bidirectional_iter_adaptor_base (+17 more)
...
Cohesion: 0.06
Nodes (34): 10. Testing strategy, 11. Open questions / deferred, 12. Resolved decisions log, 12 — Security & Identity, 1. Purpose & scope, 2. Phase scope, 3.10 Pluggable device-cert issuer (extension seam for org-managed CA), 3.11 Revocation (+26 more)

### Community 564 - "Community 564"
Cohesion: 0.06
Nodes (33): authors, description, homepage, ios, vendored_frameworks, license, name, osx (+25 more)
...
Cohesion: 0.15
Nodes (34): RNSBottomTabsScreenIconType, RNSBottomTabsScreenOrientation, RNSBottomTabsScreenSpecialEffectsRepeatedTabSelectionStruct, RNSBottomTabsScreenSystemItem, RNSBottomTabsTabBarItemLabelVisibilityMode, RNSBottomTabsTabBarMinimizeBehavior, fromRawValue(), gestureResponseDistance() (+26 more)
...
Cohesion: 0.13
Nodes (34): BOOST_CATCH_END, BOOST_DEDUCED_TYPENAME, allocate_node(), BOOST_CATCH(), BOOST_TRY(), construct_value(), deallocate_node(), delete_node_() (+26 more)
...
Cohesion: 0.11
Nodes (32): RCTCATransform3DFromTransformMatrix(), RCTCGPointFromPoint(), RCTCGRectFromRect(), RCTCGSizeFromSize(), RCTCreateCGColorRefFromSharedColor(), RCTEdgeInsetsFromUIEdgeInsets(), RCTFloatFromCGFloat(), RCTLayoutDirection() (+24 more)
...
Cohesion: 0.12
Nodes (32): Chain, connect_uds(), resolve_server_addr(), seed_chain(), try_connect_uds(), Channel, Duration, Endpoint (+24 more)

### Community 603 - "Community 603"
Cohesion: 0.08
Nodes (26): BOOST_CONTAINER_FORCEINLINE, advance(), default_init_construct_iterator, explicit, friend, m_num, std, less() (+18 more)
...
Cohesion: 0.07
Nodes (24): integral_c, apply, AUX778076_OP_IMPL_NAME<integral_c_tag,integral_c_tag>, BOOST_MPL_AUX_LAMBDA_SUPPORT, apply, shift_left, shift_left_impl, shift_left_impl< integral_c_tag,integral_c_tag > (+16 more)

### Community 607 - "Community 607"
Cohesion: 0.06
Nodes (34): `crates/proto/proto/concerto/v1/workareas.proto`, enum `DiffKind`, enum `FailureKind`, enum `RevertOutcome`, message `ArchiveWorkareaRequest`, message `CreateWorkareaRequest`, message `DiffHunk`, message `DiffPayload` (+26 more)
...
Cohesion: 0.08
Nodes (24): 01 — Core Daemon Runtime, 10. Testing strategy, 11. Open questions / deferred, 12. Resolved decisions log, 1. Purpose & scope, 2. Phase scope, 4.1 On-disk, 4.2 In-memory state (+16 more)
...
Cohesion: 0.07
Nodes (26): long_<(m_ - n_)>, plus, apply, joint_view, joint_view_tag, size_impl< aux::joint_view_tag >, advance_impl<aux::v_iter_tag>, advance< v_iter<Vector,n_>,Distance> (+18 more)

### Community 639 - "Community 639"
Cohesion: 0.07
Nodes (29): dependencies, expo, expo-constants, expo-haptics, expo-router, expo-status-bar, expo-system-ui, react (+21 more)
...
Cohesion: 0.15
Nodes (20): AsyncRead, AsyncWrite, Connected, ConnectInfo, Connection, Context, Error, Future (+12 more)
...
Cohesion: 0.16
Nodes (15): ClientKind, ConnectionPath, invalid_subject(), map_client_kind(), map_path(), map_transport_event(), map_transport_event_carries_the_frozen_oneof_arm(), parse_checks_subject_missing_repo_errors() (+7 more)
...
Cohesion: 0.07
Nodes (29): `crates/transport/src/api.rs`, enum `ChannelTag`, enum `ClientKind`, enum `ConnectionPath`, enum `TransportTelemetry`, enum `WebhookAck`, struct `ActiveSession`, struct `AuthObserver` (+21 more)
...
Nodes (26): eval_if<
          ...
          >, is_convertible< typename iterator_category_to_traversal< CategoryOrTraversal >::type, Required >, iterators::enable_if<
            mpl::and_<
        ...
        >, not_<
            ...
            >
        >, apply, enable_if_interoperable_and_random_access_traversal, is_traversal_at_least, use_operator_brackets_proxy (+18 more)
...
Nodes (36): enable_if<
    ...
    >, eval_if<
      ...
      >::type, Base, C, D, distance_to() (+28 more)
...
Cohesion: 0.08
Nodes (25): move_detail::enable_if_c<dtl::is_transparent<C>::value, R>, enable_if_transparent, is_allocator, is_allocator < Allocator,
   variadic_void_t< typename Allocator::value_type
                  , decltype(ctad_declval<Allocator&>().allocate(size_t{})) >>, value, value, is_transparent, is_transparent_base (+17 more)
...
Cohesion: 0.10
Nodes (26): forward_iterator_helper, forward_iter_adaptor_base, Base, Class, Derived, advance(), apply, bidirectional_iter_adaptor_base (+18 more)
...
Nodes (24): Category, eval_if<
    ...
    >, eval_if<
      ...
      , typename mpl::eval_if<
        ...
        >
    >, input_iterator_tag, or_<
        is_convertible<T,std::input_iterator_tag>
      , is_convertible<T,std::output_iterator_tag>
    >, BOOST_STATIC_ASSERT, facade_iterator_category, facade_iterator_category_impl (+16 more)

### Community 731 - "Community 731"
Cohesion: 0.14
Nodes (25): CancellationToken, Connection, Endpoint, IrohDuplex, Relay, RelayConfig, RelayUrl, SocketAddr (+17 more)
...
Cohesion: 0.10
Nodes (22): iterators::enable_if<
            is_interoperable< Facade1, Facade2 >
          , Return
        >, BOOST_DELETED_FUNCTION, Derived, difference_type, Facade, advance(), always_bool2, choose_difference_type (+14 more)
...
Cohesion: 0.11
Nodes (25): BOOST_MOVE_DOC0PTR, BOOST_MOVE_FORCEINLINE, BOOST_RV_REF_BEG, D1, D2, BOOST_NOEXCEPT(), deleter(), deleter_types (+17 more)
...
Cohesion: 0.13
Nodes (24): boost::base_from_member<
  ...
  >, header_holder<
    typename detail::allocator_traits<
      ...
      >::type
    >::pointer,
    multi_index_container<Value,IndexSpecifierList,Allocator> >, multi_index_base_type<
    Value,IndexSpecifierList,Allocator>::type, Allocator, allocator_type, BOOST_COPYABLE_AND_MOVABLE, copy_construct_from(), get_allocator() (+16 more)

### Community 750 - "Community 750"
Cohesion: 0.08
Nodes (25): 05 — Scheduler, 10. Testing strategy, 11. Open questions / deferred, 12. Resolved decisions log, 1. Purpose & scope, 2. Phase scope, 4.1 In-memory state, 4. Data model (+17 more)
...
Cohesion: 0.08
Nodes (25): `crates/proto/proto/concerto/v1/streams.proto`, enum `ClientKind`, enum `TransportPath`, message `AckOffsetRequest`, message `AgentExited`, message `AgentMessage`, message `AgentStarted`, message `ApprovalResolved` (+17 more)
...
Cohesion: 0.09
Nodes (22): BOOST_SYMBOL_VISIBLE, bound_memfunc_ptr_t, obj_ptr, function_allows_small_object_optimization, function_obj_ref_tag, function_return_type, function_return_type<void>, get_function_tag (+14 more)
...
Cohesion: 0.17
Nodes (22): TempDir, camel_case_canonical_spelling_parses(), disable_remote_camel_alias_parses(), disable_remote_false_and_absent_both_read_false(), fingerprint_format_matches_hex_device_id(), frozen_keys_parse_full_policy(), invalid_allowed_pairing_devices_type_reverts_and_violates(), invalid_default_permission_mode_reverts_and_violates() (+14 more)
...
Cohesion: 0.09
Nodes (23): `crates/proto/proto/concerto/v1/vcs.proto`, enum `VcsCredentialProvider`, message `CheckRun`, message `CreatePrRequest`, message `Deployment`, message `FetchIssueByUrlRequest`, message `FetchIssueRequest`, message `GetChecksRequest` (+15 more)

### Community 790 - "Community 790"
Cohesion: 0.17
Nodes (11): is_base_and_derived, is_tag, tag, tag_marker, base_token, is_noncopyable, is_tag, tag (+3 more)
...
Cohesion: 0.09
Nodes (22): authors, dependencies, ExpoModulesCore, RNScreens, description, homepage, license, name (+14 more)
...
Cohesion: 0.10
Nodes (15): contentInset(), contentOffset(), endDraggingSensitivityMultiplier(), indicatorStyle(), keyboardDismissMode(), scrollEventThrottle(), scrollIndicatorInsets(), snapToAlignment() (+7 more)
...
Nodes (16): has_range_const_iterator_impl<
            ...
            BOOST_DEDUCED_TYPENAME remove_reference<T>::type>, mpl::false_, mpl::true_, has_range_const_iterator, has_range_const_iterator_impl, has_range_const_iterator_impl<
            T,
            BOOST_DEDUCED_TYPENAME ::boost::enable_if<
                has_type<boost::range_const_iterator<T> >
            >::type
        >, has_range_iterator (+8 more)
...
Cohesion: 0.16
Nodes (17): AuditWriter, Arc, AuditEvent, AuditLogSubscriber, Mutex, Option, Self, String (+9 more)

### Community 821 - "Community 821"
Cohesion: 0.25
Nodes (20): IdentityError, KeyPair, PublicKey, Result, Signature, Typed Keychain Secrets Wrapper, Ed25519 Core & Device Identity, from_seed() (+12 more)
...
Cohesion: 0.15
Nodes (9): abstract_value_type, difference_type, iterator_range_base, iterator_range_base<IteratorT, bidirectional_traversal_tag>, iterator_range_base<IteratorT, random_access_traversal_tag>, base_type, m_Begin, m_End (+1 more)
...
Cohesion: 0.12
Nodes (11): FMT_BEGIN_NAMESPACE, FMT_END_EXPORT, Char(), copy2(), detail(), detail_exported(), dragonbox(), enums() (+3 more)
...
Cohesion: 0.09
Nodes (21): 1. Purpose, 2. Scope of V1.0, 3. What we inherit from V0.1 (unchanged), 4. Decisions locked for V1.0, 5.1 The three tiers, 5.2 The `spike` type, 5.3 Per-type verification command sets, 5.4 Execution model (pipelined + bounded-parallel) (+13 more)
...
Cohesion: 0.19
Nodes (18): AuditWriter, KeyPair, Path, PathBuf, PublicKey, Result, Secrets, concerto_dir() (+10 more)

### Community 851 - "Community 851"
Cohesion: 0.25
Nodes (8): Error, HashMap, check_run_backoff_secs(), is_rate_limited(), OpPriority, PoolsInner, rate_limited(), rate_limited_reset_at()
...
Cohesion: 0.10
Nodes (25): iterator_facade, BOOST_DEFAULTED_FUNCTION, find_iterator_base, m_Finder, finder_type, input_iterator_type, match_type, FinderT (+17 more)
...
Cohesion: 0.21
Nodes (18): Formatter, Result, Self, Managed Settings (managed.json) Enforcement, allow_flags_parse(), cap_to_auto_parses(), explicit_version_one_parses(), future_version_errors() (+10 more)

### Community 909 - "Community 909"
Cohesion: 0.10
Nodes (20): `crates/proto/proto/concerto/v1/repositories.proto`, message `AddRepoRequest`, message `CloneProgress`, message `CloneRequest`, message `ConeStats`, message `EstimateConeSizeRequest`, message `EstimateRepoSizeRequest`, message `ListRepositoriesRequest` (+12 more)
...
Cohesion: 0.10
Nodes (19): 1. Goal, 2.1 Token layer, 2.2 Tailwind theme extension, 2.3 Migration rule, 2. Theming architecture (Approach A), 3. Typography, 4. Icon system, 5.1 UI primitives (`src/components/ui/`) (+11 more)
...
Cohesion: 0.10
Nodes (19): After the orchestrator stops, Auto-Execute Prompt — Running All Tasks End-to-End, Auto-handle (do not stop for these), Boundaries (read these once, never violate), Failure recovery — concrete protocol, How to use, Initial reading (once at start), Status updates (+11 more)

### Community 941 - "Community 941"
Cohesion: 0.10
Nodes (19): After the orchestrator stops at a phase boundary, Auto-Execute Prompt — Running V1.0 Tasks, One Phase at a Time, Auto-handle (don't stop), Boundaries (never violate), Concurrency model (pipelined + bounded-parallel), Failure recovery, How to use, Initial reading (once at start) (+11 more)
...
Cohesion: 0.16
Nodes (7): ConePath, Option, Vec, parse_flat_array(), parse_workspace_cone_default(), resolve_cones(), three_layer_precedence_table()

### Community 978 - "Community 978"
Cohesion: 0.21
Nodes (9): Attach, Receiver, Self, Vec, VecDeque, Streams Service + Ring Buffer Reconnect, Attach, RingBound (+1 more)

### Community 979 - "Community 979"
Cohesion: 0.19
Nodes (16): Vec, Fn, Option, String, rate_limit_headers(), rate_limit_headers_and_synthetic_clock(), background_op_queues_and_resumes_after_reset(), budget_seeds_from_a_real_octocrab_call() (+8 more)
...
Cohesion: 0.11
Nodes (18): `crates/proto/proto/concerto/v1/sessions.proto`, enum `ApprovalDecision`, message `CreateSessionRequest`, message `ListMcpResponse`, message `ListSessionsRequest`, message `ListSessionsResponse`, message `McpScopeRequest`, message `McpServer` (+10 more)
...
Cohesion: 0.11
Nodes (17): edgeToEdgeEnabled, package, typedRoutes, expo, android, experiments, ios, name (+9 more)
...
Cohesion: 0.16
Nodes (12): A, F, run_check(), Fn, contains(), functor_wrapper, is_transparent_class_helper, Fn (+4 more)
...
Cohesion: 0.16
Nodes (13): ExpoAppDelegate, ExpoReactNativeFactoryDelegate, NSUserActivity, RCTBridge, RCTReactNativeFactory, AppDelegate, ReactNativeDelegate, Any (+5 more)

### Community 1026 - "Community 1026"
Cohesion: 0.05
Nodes (43): is_default_constructible, is_destructible, is_constructible_imp, is_constructible<Ref&, Arg>, is_constructible<Ref&, void>, is_constructible<T>, is_constructible<T, void>, is_constructible<void> (+35 more)
...
Cohesion: 0.12
Nodes (16): authors, header_dir, homepage, license, name, platforms, ios, pod_target_xcconfig (+8 more)
...
Cohesion: 0.12
Nodes (16): Canonical class-migration map, Desktop UI Redesign Implementation Plan, File Structure, Self-Review, Task 10: Theme-aware xterm terminal, Task 11: Theme-aware Monaco diff viewer, Task 12: Final sweep — residual-color grep gate + full two-theme verification, Task 1: Token foundation — CSS variables, Tailwind extension, root + FOUC script (+8 more)

### Community 1031 - "Community 1031"
Cohesion: 0.13
Nodes (15): range_size<T>, has_size_type, value, range_size_, range_size_<
            C,
            BOOST_DEDUCED_TYPENAME ::boost::enable_if<has_size_type<C>, void>::type
        >, range_size<C, true>, type, type (+7 more)

### Community 1032 - "Community 1032"
Cohesion: 0.12
Nodes (16): 10. Documentation changes, 11. Risks & mitigations, 12. Out of scope, 1. Motivation, 2. Target conceptual model, 3. Decisions locked (this design), 4.1 Removed, 4.2 Changed (+8 more)
...
Cohesion: 0.31
Nodes (15): create_workspace(), next_event(), next_workspace_event(), run(), subscribe(), Channel, Duration, Event (+7 more)

### Community 1059 - "Community 1059"
Cohesion: 0.23
Nodes (15): AgentEvent, Arc, Duration, F, PathBuf, Persistence, Receiver, TempDir (+7 more)
...
Cohesion: 0.20
Nodes (10): `crates/proto/proto/concerto/v1/workspaces.proto`, message `CreateWorkspaceRequest`, message `ListWorkspacesRequest`, message `ListWorkspacesResponse`, message `UpdateWorkspaceSettingsRequest`, message `Workspace`, message `WorkspaceId`, message `WorkspaceRepoSpec` (+2 more)

### Community 1062 - "Community 1062"
Cohesion: 0.12
Nodes (15): `crates/agent-host/src/api.rs`, `crates/error/src/api.rs`, `crates/gix-wrap/src/api.rs`, enum `AgentKind`, enum `CloneStrategy`, enum `Error`, enum `HostFrame`, Public Rust API (+7 more)

### Community 1063 - "Community 1063"
Cohesion: 0.12
Nodes (15): `crates/persist/migrations/0001_initial_schema.sql`, `crates/persist/migrations/0002_workareas_settings_json.sql`, `crates/persist/migrations/0003_sessions_last_acked_seq.sql`, `crates/persist/migrations/0004_schedules.sql`, `crates/persist/migrations/0005_skills_index.sql`, `crates/persist/migrations/0006_suggestion_learn.sql`, `crates/persist/migrations/0007_tool_approvals_urgent.sql`, `crates/persist/migrations/0008_pull_requests.sql` (+7 more)
...
Cohesion: 0.38
Nodes (15): endian32(), endian64(), FBxxHash64(), fetch32(), fetch64(), fetch8(), finalize(), h32bytes() (+7 more)

### Community 1068 - "Community 1068"
Cohesion: 0.12
Nodes (15): CI release — `release.yml`, Component 1 — Combined dev loop, Component 2 — `make stop-core` → `scripts/stop-core.sh`, Component 3 — Embedded edition packaging, Config overlay, Decisions (locked during brainstorming), Embedded-Core dev loop, daemon control, and packaging, Local build — `make build-embedded` (+7 more)

### Community 1069 - "Community 1069"
Cohesion: 0.12
Nodes (15): 1. `crates/core` — extract boot into the library (the one nontrivial refactor), 2. `apps/desktop/src-tauri` — optional dependency + embed module, 3. `core_client.rs` — make the socket path injectable, Architecture, Coexistence guard, Components & changes, Decisions (locked during brainstorming), Embedded-Core mode for the Desktop app (+7 more)
...
Cohesion: 0.12
Nodes (15): 1. Purpose, 2. Scope of V0.1, 3. Decisions locked, 4. Phase structure, 5. Verification model, 6. Task-file template, 7. Operator workflow (how to execute a task), 8. Revising the plan (+7 more)
...
Cohesion: 0.13
Nodes (8): Hall of fame, In scope, Our commitment, Out of scope, Reporting a vulnerability, Security Policy, What we will and won't do, missing_path_classified_by_prefix()

### Community 1108 - "Community 1108"
Cohesion: 0.13
Nodes (9): shuffle_order_engine, It, shuffle_output, result_type, T, It, shuffle_output, result_type (+1 more)
...
Cohesion: 0.30
Nodes (8): function_buffer(), function_obj_tag, function_ptr_tag, functor_manager, functor_manager_a, functor_manager_common, member_ptr_tag, functor_manager_operation_type
...
Cohesion: 0.10
Nodes (10): AtomicI64, NowSecs, Self, String, GitHubProvider, MockServer, epoch_secs_to_rfc3339(), FakeJira (+2 more)
...
Cohesion: 0.14
Nodes (14): description, type, archive, run, scripts, setup, description, type (+6 more)

### Community 1186 - "Community 1186"
Cohesion: 0.15
Nodes (12): sequence_tag_impl< !aux::is_msvc_eti_arg<Sequence>::value >
        ::template result_<Sequence>, sequence_tag_impl<
          ::boost::mpl::aux::has_tag<Sequence>::value
        , ::boost::mpl::aux::has_begin<Sequence>::value
        >::template result2_<Sequence>, result_, result2_, sequence_tag, sequence_tag_impl, sequence_tag_impl<false>, result_ (+4 more)
...
Cohesion: 0.23
Nodes (11): container_rebind, real_allocator, container_or_allocator_rebind, container_or_allocator_rebind_impl, container_or_allocator_rebind_impl<AllocatorOrContainer, ToType, false>, container_or_allocator_rebind_impl<void, ToType, false>, container_or_allocator_rebind, container_or_allocator_rebind_impl (+3 more)

### Community 1221 - "Community 1221"
Cohesion: 0.15
Nodes (12): Architecture decisions, Coding standards, Contributing to Concerto, Developer Certificate of Origin (DCO), License, License compliance, Project structure, Security (+4 more)
...
Cohesion: 0.17
Nodes (7): facebook(), llvh(), type(), hermes(), RecordType, namespace, namespace

### Community 1226 - "Community 1226"
Cohesion: 0.15
Nodes (13): `crates/proto/proto/concerto/v1/files.proto`, message `DownloadChunk`, message `DownloadRequest`, message `FileEntry`, message `ListFilesRequest`, message `ListFilesResponse`, message `StatRequest`, message `StatResult` (+5 more)
...
Cohesion: 0.18
Nodes (10): O1_size_impl, BOOST_MPL_AUX_LAMBDA_SUPPORT, O1_size, size_impl< aux::vector_tag >, size_impl< aux::vector_tag<N> >, BOOST_MPL_AUX_LAMBDA_SUPPORT, O1_size, size_impl< aux::vector_tag > (+2 more)
...
Cohesion: 0.15
Nodes (12): Commit message, Definition of Done, Goal, Handoff Notes (fill in when finishing), Implementation notes, Inputs to read before starting, Outputs, Public interface this task locks (+4 more)
...
Cohesion: 0.15
Nodes (12): Commit message, Definition of Done, Goal, Handoff Notes (filled in when finishing), Implementation notes, Inputs to read before starting, Outputs, Public interface this task locks (+4 more)
...
Cohesion: 0.15
Nodes (12): Commit message, Definition of Done, Goal, Handoff Notes, Implementation notes, Inputs to read before starting, Outputs, Public interface this task locks (+4 more)
...
Cohesion: 0.18
Nodes (10): extract_const_iterator, range_const_iterator_helper<
            BOOST_DEDUCED_TYPENAME remove_reference<C>::type
        >, range_const_iterator, range_const_iterator_helper, range_const_iterator_helper<std::pair<Iterator,Iterator> >, range_const_iterator_helper< T[sz] >, range_const_iterator, range_const_iterator_helper (+2 more)
...
Cohesion: 0.17
Nodes (12): `crates/relay/src/api.rs`, struct `BandwidthCounter`, struct `EndpointRoute`, struct `Relay`, struct `RelayConfig`, struct `RelayState`, struct `WebhookRouteMetrics`, struct `WebhookRouteServer` (+4 more)

### Community 1389 - "Community 1389"
Cohesion: 0.17
Nodes (11): Reference facts (from recon), Self-review, Session Tabs + Real Delete — Implementation Plan, Task A: Proto — add `DeleteSession` + regen, Task B: Persist — `delete` with cascade + test, Task C+D: Supervisor `delete_session` + Core handler, Task E: Tauri shell dispatch arm, Task F: TS client wrapper (+3 more)

### Community 1390 - "Community 1390"
Cohesion: 0.24
Nodes (9): predicate_facade, is_classifiedF, m_Locale, m_Type, pred_notF, m_Pred, locale, mask (+1 more)
...
Cohesion: 0.33
Nodes (11): byte_eviction_for_session_io_bounds_by_bytes_not_count(), byte_eviction_retains_single_oversized_chunk(), count_eviction_drops_oldest_and_advances_floor(), gap_detection_boundary(), io_event(), prune_to_min_ack_never_drops_unacked_by_attached_subscriber(), prune_with_zero_subscribers_retains_tail(), publish_assigns_monotonic_offsets_from_zero() (+3 more)
...
Cohesion: 0.30
Nodes (11): require_socket(), Command, ExitCode, Option, PathBuf, Result, Cli, Command (+3 more)
...
Cohesion: 0.18
Nodes (10): Embedded-Core Mode Implementation Plan, File Structure, Self-Review Notes, Task 1: Extract Core boot into `concerto_core::boot`, Task 2: Make the desktop gRPC client's socket path injectable, Task 3: Add the `embedded-core` feature and the `embedded` module, Task 4: Boot embedded Core from the Tauri `setup` hook, Task 5: Window-close = full shutdown in embedded mode (+2 more)

### Community 1453 - "Community 1453"
Cohesion: 0.18
Nodes (10): Changelog, Concerto, Contributing, Embedded mode (testing & standalone), Install (macOS), License, Repository layout, Run your first agent (+2 more)

### Community 1454 - "Community 1454"
Cohesion: 0.18
Nodes (11): relocate_on, relocate_on_66, relocate_on_75, relocate_on_80, relocate_on_85, relocate_on_90, relocate_on_66, relocate_on_75 (+3 more)

### Community 1455 - "Community 1455"
Cohesion: 0.18
Nodes (10): Fixtures, iPhone 13 or newer (release build — required for a real fps number), Layout, Pixel 6 or newer, Quick look without a device (indicative only), rn-diff-spike — throwaway React Native diff-viewer perf harness (Task 103), Run it on a real device (what the operator does), The two numbers, in-app (+2 more)

### Community 1456 - "Community 1456"
Cohesion: 0.18
Nodes (10): compilerOptions, noUncheckedIndexedAccess, noUnusedLocals, noUnusedParameters, paths, strict, exclude, extends (+2 more)
...
Cohesion: 0.33
Nodes (9): civil_from_unix(), path_for_today(), run(), Duration, Option, Path, PathBuf, Result (+1 more)

### Community 1527 - "Community 1527"
Cohesion: 0.22
Nodes (6): Actor, ActorContext, Config, SchedulerHandle, Schedule Budget Guardrails, SchedulerActor

### Community 1528 - "Community 1528"
Cohesion: 0.20
Nodes (10): 3.1 Two backends, one front: `Schedule` is the unified record, 3.2 Cron parsing: cron-parser crate, 5-field standard + extensions, 3.3 Jitter: random offset within a 60-second window, 3.4 Run dispatch: pre-spawn the agent, never block, 3.5 Worktree mode: latest vs fresh, 3.6 Budget guardrails, 3.7 Cloud-schedule sync (Pro/Max only), 3.8 Promotion: `/loop` → scheduled task (+2 more)
...
Nodes (8): extract_iterator<
            ...
            BOOST_DEDUCED_TYPENAME remove_reference<C>::type
        >, range_mutable_iterator, range_mutable_iterator< std::pair<Iterator,Iterator> >, range_mutable_iterator< T[sz] >, range_mutable_iterator, range_mutable_iterator< std::pair<Iterator,Iterator> >, range_mutable_iterator< T[sz] >

### Community 1533 - "Community 1533"
Cohesion: 0.20
Nodes (10): `crates/identity/src/api.rs`, struct `DeviceCert`, struct `DeviceContext`, struct `KeyPair`, struct `LocalCoreIssuer`, struct `PairingRequest`, struct `PublicKey`, struct `Signature` (+2 more)

### Community 1534 - "Community 1534"
Cohesion: 0.20
Nodes (9): 1. On the machine playing the **Core**, 2. On the machine playing the **client** (a different network), iroh-nat-spike — throwaway NAT-diversity harness (Task 101), Relay options, Running a matrix row, Settle window, Standing up your own throwaway relay (optional, for the relay-controlled row), Verification (Task 101 tier: spike) (+1 more)

### Community 1535 - "Community 1535"
Cohesion: 0.20
Nodes (10): description, type, description, type, description, type, properties, default_deliberation_mode (+2 more)
...
Cohesion: 0.06
Nodes (28): BOOST_MPL_AUX_LAMBDA_SUPPORT, apply, modulus, modulus_impl, modulus_impl< integral_c_tag,integral_c_tag >, modulus_impl< na,na >, modulus_impl< na,Tag >, modulus_impl< Tag,na > (+20 more)
...
Cohesion: 0.35
Nodes (7): AckOffsetRequest, Request, Response, Result, Status, Subject, SubscribeStream
...
Cohesion: 0.20
Nodes (9): 1. The nine locked decisions, 2. Resolved sub-decisions (smaller forks — locked so the 8 authors stay consistent), 3. Migration-number reservation, 4. Cross-cutting FROZEN contracts (owner → consumers), 5. The two inserts (amend `README.md §6` Phase-3 inventory), 6. Refined dependencies (beyond the README inventory rows), 7. Verification note for the desktop tasks (322–324), 8. Concurrency / wave map (pipelined + bounded-parallel execution) (+1 more)

### Community 1625 - "Community 1625"
Cohesion: 0.22
Nodes (8): 0.0.1 — V0.1 alpha (2026-05-28), Changelog, Known limitations (V0.1), Phase 0 — Repo bootstrap, Phase 1 — Foundations, Phase 2 — Vertical slice, Phase 3 — Subsystem thickening, Phase 4 — Ship-readiness

### Community 1626 - "Community 1626"
Cohesion: 0.28
Nodes (8): ConstantsInitialWindowMetrics, ConstantsInitialWindowMetricsFrame, ConstantsInitialWindowMetricsInsets, Builder(), JS(), namespace(), Constants, NS_ASSUME_NONNULL_BEGIN
...
Cohesion: 0.22
Nodes (8): 1. Prerequisites, 2. Install the Core, 3. Start the Desktop, 4. Your first workspace, 5. Troubleshooting, 6. Where things live, Getting started with Concerto, Next steps
...
Cohesion: 0.22
Nodes (9): `crates/proto/proto/concerto/v1/devices.proto`, message `CompletePairingRequest`, message `CompletePairingResponse`, message `CoreInfo`, message `DeviceEntry`, message `ListDevicesResponse`, message `PairingChallenge`, message `RevokeDeviceRequest` (+1 more)

### Community 1636 - "Community 1636"
Cohesion: 0.22
Nodes (9): `crates/proto/proto/concerto/v1/schedules.proto`, message `CreateScheduleRequest`, message `ListSchedulesRequest`, message `ListSchedulesResponse`, message `Schedule`, message `ScheduleHistoryResponse`, message `ScheduleId`, message `ScheduleRun` (+1 more)
...
Cohesion: 0.22
Nodes (8): Embedded-Core Dev Loop, Daemon Control & Packaging Implementation Plan, File Structure, Self-Review Notes, Task 1: `make stop-core` — stop the standalone daemon, Task 2: Combined hot-reload dev loop (real data + cargo-watch), Task 3: Embedded edition config overlay + `make build-embedded`, Task 4: Wire the embedded edition into the release workflow, Task 5: Document the new workflow in the README
...
Cohesion: 0.22
Nodes (7): s_iter_get, apply, begin_impl< aux::set_tag >, end_impl< aux::set_tag >, apply, begin_impl< aux::set_tag >, end_impl< aux::set_tag >
...
Cohesion: 0.25
Nodes (8): Client, RefreshToken, Result, SecretValue, Self, JiraResult, JiraClient, parse_jira_key()
...
Cohesion: 0.40
Nodes (9): CoreUnderTest, Path, String, TempDir, git(), list_workarea_repos_is_scoped_to_the_workarea(), make_bare_with_commit(), seed() (+1 more)
...
Cohesion: 0.22
Nodes (8): After the agent reports done (operator checklist), How to use, Mandatory reading order (do this before writing any code), Prompt Template — Executing a Concerto Task, Rules of engagement, The template (copy from the `---` markers), When to stop and ask, When you finish
...
Cohesion: 0.22
Nodes (8): How to use, Mandatory reading order (before writing any code), Parallel build (optional — to go faster), Prompt Template — Executing a Concerto V1.0 Task, Rules of engagement, The template (copy from the `---` markers), When to stop and ask, When you finish
...
Cohesion: 0.25
Nodes (7): facebook(), valueToJson(), JSONFactory, JSONValue, namespace, Serializable, std
...
Cohesion: 0.43
Nodes (8): integer_traits_base< ::boost::long_long_type, (1LL << (sizeof(::boost::long_long_type) * CHAR_BIT - 1)), ~(1LL << (sizeof(::boost::long_long_type) * CHAR_BIT - 1))>, integer_traits_base< ::boost::long_long_type, -_LLONG_MAX - _C2, _LLONG_MAX>, integer_traits_base< ::boost::long_long_type, LLONG_MIN, LLONG_MAX>, integer_traits_base< ::boost::long_long_type, LONG_LONG_MIN, LONG_LONG_MAX>, integer_traits_base< ::boost::long_long_type, LONGLONG_MIN, LONGLONG_MAX>, numeric_limits< ::boost::long_long_type>, integer_traits< ::boost::long_long_type>, integer_traits< ::boost::long_long_type>

### Community 1738 - "Community 1738"
Cohesion: 0.25
Nodes (8): `crates/proto/proto/concerto/v1/runtime.proto`, enum `TransportKind`, message `NatStats`, message `NetworkStats`, message `ResourceLimits`, message `RuntimeStatus`, message `ServerCapabilities`, service `Runtime`

### Community 1739 - "Community 1739"
Cohesion: 0.25
Nodes (8): `crates/proto/proto/concerto/v1/skills.proto`, message `ListSkillsRequest`, message `ListSkillsResponse`, message `RefreshMarketplacesRequest`, message `RefreshMarketplacesResponse`, message `Skill`, message `ToggleSkillRequest`, service `Skills`

### Community 1740 - "Community 1740"
Cohesion: 0.43
Nodes (6): code_sign_if_enabled(), install_bcsymbolmap(), install_dsym(), install_framework(), strip_invalid_archs(), Pods-rndiffspike-frameworks.sh script
...
Cohesion: 0.29
Nodes (6): remove_if_impl, reverse_remove_if_impl, remove_impl, reverse_remove_impl, remove_impl, reverse_remove_impl

### Community 1744 - "Community 1744"
Cohesion: 0.25
Nodes (8): properties, description, enum, type, description, type, mode, pattern
...
Cohesion: 0.32
Nodes (7): blake2b_256(), run(), Code, Path, Result, String, Vec
...
Cohesion: 0.29
Nodes (6): 1. Clone-strategy picker is now always visible, 2. Add a repository right when creating a project, PR Description, PR Title, Refactor, Scope / verification
...
Cohesion: 0.25
Nodes (7): Ascii, Clone, FnMut, MetadataValue, Request, CertInterceptorFactory, Status
...
Cohesion: 0.38
Nodes (6): debugger(), getGCExecTrace(), hermes(), jsi(), namespace, virtual

### Community 1860 - "Community 1860"
Cohesion: 0.48
Nodes (7): integer_traits_base< ::boost::ulong_long_type, 0, ~0uLL>, integer_traits_base< ::boost::ulong_long_type, 0, ULLONG_MAX>, integer_traits_base< ::boost::ulong_long_type, 0, ULONG_LONG_MAX>, integer_traits_base< ::boost::ulong_long_type, 0, ULONGLONG_MAX>, numeric_limits< ::boost::ulong_long_type>, integer_traits< ::boost::ulong_long_type>, integer_traits< ::boost::ulong_long_type>

### Community 1861 - "Community 1861"
Cohesion: 0.67
Nodes (4): integer_traits_base<short, SHRT_MIN, SHRT_MAX>, numeric_limits<short>, integer_traits<short>, integer_traits<short>

### Community 1862 - "Community 1862"
Cohesion: 0.15
Nodes (12): `crates/proto/proto/concerto/v1/common.proto`, `crates/proto/proto/concerto/v1/suggestions.proto`, enum `PermissionMode`, message `Chip`, message `ConcertoError`, message `GetSuggestionsRequest`, message `Identifier`, message `RecordSuggestionOutcomeRequest` (+4 more)

### Community 1863 - "Community 1863"
Cohesion: 0.29
Nodes (7): `crates/keychain/src/api.rs`, enum `CoreSecretSlot`, enum `Provider`, enum `SecretKind`, enum `VcsSecretSlot`, struct `Secrets`, struct `SecretValue`
...
Cohesion: 0.43
Nodes (5): fail(), wait_for_file(), wait_for_log(), wait_for_port(), common.sh script
...
Cohesion: 0.29
Nodes (6): list16_c, list5_c, list_c<
...
Cohesion: 0.29
Nodes (5): msvc_eti_base<
        typename size_impl< typename sequence_tag<Sequence>::type >
            ::template apply< Sequence >::type
      >::type, BOOST_MPL_AUX_LAMBDA_SUPPORT, size, BOOST_MPL_AUX_LAMBDA_SUPPORT, size
...
Nodes (5): represents
        ...
        >, BOOST_MPL_AUX_LAMBDA_SUPPORT, is_callable_builtin, BOOST_MPL_AUX_LAMBDA_SUPPORT, is_callable_builtin

### Community 1870 - "Community 1870"
Cohesion: 0.29
Nodes (3): runtime_error, bad_archive_exception, bad_archive_exception
...
Cohesion: 0.29
Nodes (7): 3.1 Daemonization strategy: rely on OS integration, not double-fork, 3.2 Supervision tree shape: typed actor pattern over tokio tasks, 3.3 Single-instance guard: advisory lock on a PID file, 3.4 Configuration model: layered, JSON, hot-reload via SIGHUP / equivalent, 3.5 Tray / menu-bar UI host: sidecar Tauri process, not in-Core, 3.6 OpenTelemetry exporter: opt-in, off by default, 3. Key design decisions (sub-system-internal)
...
Cohesion: 0.40
Nodes (5): CloneRequest, run(), Path, Result, String

### Community 1980 - "Community 1980"
Cohesion: 0.40
Nodes (5): run(), ListSchedulesRequest, Path, Result, String

### Community 1981 - "Community 1981"
Cohesion: 0.70
Nodes (3): AgentSupervisorHandle, Persistence, Self
...
Cohesion: 0.50
Nodes (4): apply, index_applier, multi_index_base_type, nth_layer
...
Cohesion: 0.40
Nodes (5): run(), SubscribeRequest, Path, Result, String
...
Cohesion: 0.40
Nodes (3): PathBuf, status_without_core_names_the_socket(), tempdir_path()
...
Cohesion: 0.33
Nodes (5): facebook(), inexactEquals(), namespace, Size, std

### Community 1999 - "Community 1999"
Cohesion: 0.33
Nodes (5): numeric_limits<T>, integer_traits, integer_traits_base, integer_traits<wchar_t>, integer_traits

### Community 2000 - "Community 2000"
Cohesion: 0.40
Nodes (4): frameSize(), paddingStart(), Float, Size

### Community 2001 - "Community 2001"
Cohesion: 0.33
Nodes (6): description, items, type, additionalProperties, required, files_to_copy_rules

### Community 2002 - "Community 2002"
Cohesion: 0.67
Nodes (5): emit_brace_blocks(), gen_proto(), gen_rust_api(), gen_schema(), regen-interfaces.sh script

### Community 2003 - "Community 2003"
Cohesion: 0.29
Nodes (6): set0_c, set20_c, set_c, set_c<
          T, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX
        , LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX
        , LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX
        >, set_c, set_c<
...
Cohesion: 0.33
Nodes (5): Layout, Running, tonic-iroh-spike — throwaway Tonic-over-Iroh benchmark (Task 102), What it does and does NOT measure, What it measures

### Community 2111 - "Community 2111"
Cohesion: 0.33
Nodes (5): Concerto Trademark Policy, Permitted nominative use — no permission needed, Questions, Uses that require permission, What forks should do
...
Cohesion: 0.40
Nodes (4): ChecksOutcome, Duration, RepositoryId, RequiredChecks
...
Cohesion: 0.70
Nodes (4): CancellationToken, SchedulerHandle, run_expiration_sweep(), run_fire_loop()
...
Cohesion: 0.40
Nodes (4): NAME, Builder(), doBuild(), class

### Community 2137 - "Community 2137"
Cohesion: 0.40
Nodes (4): facebook(), maxOrDefined(), FloatOptional, namespace

### Community 2138 - "Community 2138"
Cohesion: 0.50
Nodes (3): facebook(), hermes(), namespace

### Community 2139 - "Community 2139"
Cohesion: 0.40
Nodes (4): RCTTextInputHandleCommand(), id, NSArray, NSString

### Community 2140 - "Community 2140"
Cohesion: 0.40
Nodes (4): EventEmitterCallbackWrapper(), facebook(), interface, namespace

### Community 2141 - "Community 2141"
Cohesion: 0.40
Nodes (4): facebook(), HermesExecutor(), class, namespace

### Community 2142 - "Community 2142"
Cohesion: 0.40
Nodes (4): HermesRuntimeSamplingProfileSerializer(), tracing(), class, namespace

### Community 2143 - "Community 2143"
Cohesion: 0.40
Nodes (4): RCTRNSSearchBarHandleCommand(), id, NSArray, NSString

### Community 2145 - "Community 2145"
Cohesion: 0.40
Nodes (5): type, writable_paths_outside_worktree, description, items, type

### Community 2146 - "Community 2146"
Cohesion: 0.40
Nodes (4): RCTScrollViewHandleCommand(), id, NSArray, NSString

### Community 2147 - "Community 2147"
Cohesion: 0.67
Nodes (3): set15_c, set_c<
          T, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14
...
Cohesion: 0.50
Nodes (4): ImageSource, iconImageSource(), iconResource(), selectedIconImageSource()

### Community 2349 - "Community 2349"
Cohesion: 0.67
Nodes (4): integer_traits_base<bool, false, true>, numeric_limits<bool>, integer_traits<bool>, integer_traits<bool>

### Community 2350 - "Community 2350"
Cohesion: 0.67
Nodes (4): integer_traits_base<char, CHAR_MIN, CHAR_MAX>, numeric_limits<char>, integer_traits<char>, integer_traits<char>

### Community 2351 - "Community 2351"
Cohesion: 0.33
Nodes (6): integer_traits_base< __int64, _I64_MIN, _I64_MAX>, numeric_limits< __int64>, integer_traits< __int64>, integer_traits_base, integer_traits< __int64>, integer_traits<wchar_t>

### Community 2352 - "Community 2352"
Cohesion: 0.67
Nodes (4): integer_traits_base<int, INT_MIN, INT_MAX>, numeric_limits<int>, integer_traits<int>, integer_traits<int>

### Community 2353 - "Community 2353"
Cohesion: 0.67
Nodes (4): integer_traits_base<long, LONG_MIN, LONG_MAX>, numeric_limits<long>, integer_traits<long>, integer_traits<long>

### Community 2354 - "Community 2354"
Cohesion: 0.67
Nodes (4): integer_traits_base<signed char, SCHAR_MIN, SCHAR_MAX>, numeric_limits<signed char>, integer_traits<signed char>, integer_traits<signed char>

### Community 2355 - "Community 2355"
Cohesion: 0.67
Nodes (4): integer_traits_base<unsigned char, 0, UCHAR_MAX>, numeric_limits<unsigned char>, integer_traits<unsigned char>, integer_traits<unsigned char>

### Community 2356 - "Community 2356"
Cohesion: 0.67
Nodes (4): integer_traits_base< unsigned __int64, 0, _UI64_MAX>, numeric_limits< unsigned __int64>, integer_traits< unsigned __int64>, integer_traits< unsigned __int64>

### Community 2357 - "Community 2357"
Cohesion: 0.67
Nodes (4): integer_traits_base<unsigned int, 0, UINT_MAX>, numeric_limits<unsigned int>, integer_traits<unsigned int>, integer_traits<unsigned int>

### Community 2358 - "Community 2358"
Cohesion: 0.67
Nodes (4): integer_traits_base<unsigned long, 0, ULONG_MAX>, numeric_limits<unsigned long>, integer_traits<unsigned long>, integer_traits<unsigned long>

### Community 2359 - "Community 2359"
Cohesion: 0.67
Nodes (4): integer_traits_base<unsigned short, 0, USHRT_MAX>, numeric_limits<unsigned short>, integer_traits<unsigned short>, integer_traits<unsigned short>

### Community 2360 - "Community 2360"
Cohesion: 0.50
Nodes (3): EX_DEV_CLIENT_NETWORK_INSPECTOR, expo.jsEngine, newArchEnabled
...
Cohesion: 0.50
Nodes (3): RCTIsReactRootView(), end, NSNumber

### Community 2370 - "Community 2370"
Cohesion: 0.50
Nodes (3): RCTLayoutMetricsEqualToLayoutMetrics(), BOOL, RCTLayoutMetrics

### Community 2371 - "Community 2371"
Cohesion: 0.50
Nodes (3): RCTStringViewFromNSString(), NS_ASSUME_NONNULL_BEGIN, NSString
...
Cohesion: 0.50
Nodes (4): description, enum, type, default_permission_mode

### Community 2374 - "Community 2374"
Cohesion: 0.50
Nodes (4): run_script_mode, description, enum, type

### Community 2375 - "Community 2375"
Cohesion: 0.50
Nodes (4): $schema, default, description, type
...
Cohesion: 0.17
Nodes (8): AgentSupervisorActor, AgentEvent, MessageRole, Actor, ActorContext, Config, Session, Concerto Preamble
...
Nodes (3): move_detail::and_
      ...
      >, is_memtransfer_copy_constructible, is_memtransfer_copy_constructible
...
Nodes (3): move_detail::and_
      ...
      , is_same< typename remove_const< typename ::boost::container::iter_value<I>::type >::type
               ...
               >
      >, are_contiguous_and_same, are_contiguous_and_same

### Community 2935 - "Community 2935"
Cohesion: 0.67
Nodes (3): remove_cv<typename get_element_type<T>::type>, get_cvelement, get_cvelement

### Community 2940 - "Community 2940"
Cohesion: 0.67
Nodes (3): bottom(), preferredInspectorColumnWidthOrFraction(), Float

### Community 3000 - "Community 3000"
Cohesion: 0.67
Nodes (3): setup_workarea, description, type

### Community 3008 - "Community 3008"
Cohesion: 0.67
Nodes (3): set10_c, set_c<
          T, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, LONG_MAX, LONG_MAX
        , LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX
        , LONG_MAX
        >, set_c<
...
Cohesion: 0.50
Nodes (4): is_same_cvelement_and_convertible, same_cvless, value, is_unique_ptr_convertible

### Community 3018 - "Community 3018"
Cohesion: 0.67
Nodes (3): set2_c, set_c<
          T, C0, C1, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX
        , LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX
        , LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX, LONG_MAX
        >, set_c<
...
Cohesion: 0.67
Nodes (3): map_msg_role(), MessageRole, MsgRole
...
Cohesion: 0.67
Nodes (3): represents_impl<Tag, detail::retag_default_cc<QueryTag,Tag> >, represents, represents
...
Cohesion: 0.67
Nodes (3): it(), iterator(), write

## Knowledge Gaps
- **19197 isolated node(s):** `PreToolUse`, `name`, `private`, `version`, `type` (+19192 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2916 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ordered_index_node` connect `Community 290` to `Community 233`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `ordered_index_node` connect `Community 290` to `Community 233`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `yoga` connect `Community 284` to `Community 3458`, `Community 3459`, `Community 4752`, `Community 4753`, `Community 3475`, `Community 4756`, `Community 4766`, `Community 4768`, `Community 3889`, `Community 3902`, `Community 3906`, `Community 323`, `Community 328`, `Community 331`, `Community 1998`, `Community 2012`, `Community 375`, `Community 4321`, `Community 4324`, `Community 2021`, `Community 2539`, `Community 2030`, `Community 4334`, `Community 372`, `Community 2039`, `Community 4345`, `Community 254`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **What connects `PreToolUse`, `name`, `private` to the rest of the system?**
  _19210 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.036487322201607914 - nodes in this community are weakly interconnected._
